...
import { Play, Download, Send, Heart, BookOpen, Calendar, ShieldCheck, Megaphone, Image as ImageIcon, X } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      {/* Prayer Request Form */}
      <section id="prayer" className="py-16 px-4 bg-slate-900/30">
